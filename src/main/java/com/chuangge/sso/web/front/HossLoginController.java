package com.chuangge.sso.web.front;
...
import com.chuangge.sso.common.BrowserCacheUtils;
import com.chuangge.sso.common.util.CasManagerUtils;
import com.chuangge.sso.common.util.Constants;
import com.chuangge.sso.common.util.Jsonp;
import com.chuangge.sso.common.util.WebUtility;
...
public class HossLoginController {
	...
	public String success(HttpServletRequest request, ModelMap model) {
		...
		if (cookie.containsKey(Constants.CAS_TGC_KEY)
			...
			String redirect = "http://localhost:8082/biz-user-web/index.htm" + "?" + Constants.CAS_TICKET_KEY + "="
	...
	public void loginSuccess(UserInfoDTO userInfoDTO, HttpServletResponse response, HttpServletRequest request)
		...
		String redirect = "http://localhost:8082/biz-user-web/index.htm";
