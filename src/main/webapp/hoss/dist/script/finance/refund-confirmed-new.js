...
define(function (require) {
    ...
    var urlAffirmOther =  apiHost + '/hoss/finance/refund/updateRefundDownNew.do?clientRefundAmountRecordId=';
    var urlRefundAffirmSecond = apiHost + '/hoss/finance/refund/updateRefundAffirmSecond.do?refundAmountId=';
    ...
    function domReady() {
        ...
        $searchForm.on('submit', function (event) {
            ...
            $.ajax($.extend({
                url: apiHost + '/hoss/finance/refund/getRefundListNew.do',
...
//            console.log('back-list');
        ...
        $leadingOut.on('click', function () {
            var leadingOuturl = apiHost + '/hoss/finance/refund/leadingOutNew.do?' + $searchForm.serialize();
...
//                $("[name=refundbox]:checked").attr("checked",false);
        ...
        //快钱退款，再次发起退款
        window.refundAffirmSecond=refundAffirmSecond;
        function refundAffirmSecond(objvalue,objstr){
            if(!confirm("是否进行："+objstr +"操作")){
                return false;
            }
            updateRefund(urlRefundAffirmSecond,objvalue);
        }
        //获取选中的复选框值
