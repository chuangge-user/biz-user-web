define(function (require) {
                ...
                doneCallback.call(
                    ...
                    function (data) {
                        if("1"!=data.status&&1!=data.status){
                            ...
                            $("#flowStatus").text(flowStatus[data.data.typeWf]);if(isEdit==0){
                                $("#isEdit").show();
                                $("#noEdit").hide();
                            }else{
                                $("#isEdit").hide();
    ...
    function checkNum(){
        ...
        var income = parseFloat(group_buy_income)+parseFloat(separate_income)+parseFloat(advertise_income)+parseFloat(other_income);
