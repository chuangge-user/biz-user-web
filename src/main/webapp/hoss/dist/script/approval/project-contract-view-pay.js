define(function (require) {
    ...
    $(function () {
        ...
        function initAjax() {
            $.ajax($.extend({
                url: apiHost + '/hoss/contract/pay/findContractPayById.do?contractPayId=' + contractPayId + "&optionType=" + "view",
                beforeSend: function () {
                }
            }, jsonp))
                .done(function (data) {
                    function useless(data) {
                        ...
                        $('.pay_contract_projectId').text(dataObj.projectName); // 项目名称
                        $('.pay_contract_amount').text(cmApplyContractPay.auditAmount || 0);
                        $('.pay_contract_contractNo').html("<a href='project-contract-view-approval.html?businessKey="+cmApplyContract.id+"&wfInstanceId="+cmApplyContract.wfInstanceId+"'>"+cmApplyContract.flowNo+"</a>");
