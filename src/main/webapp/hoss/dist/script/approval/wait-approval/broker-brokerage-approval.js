...
//        $cityList.change(util.clearClient); // 选择城市 清空已经选中的成交客户
        ...
        util.loadInfo('broker', delegateApproval, 'approval');
        ...
        function modalClick(e){
            util.brokerageModalClick(e, 'broker');
        }
    ...
    function initWorkFlow(){
        ...
        workflowObj.processKey = workflowProp.definitionConstants.GRYJ;
