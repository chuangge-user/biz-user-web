                ...
                doneCallback.call(
                    ...
                    function (data) {
                        if("1"!=data.status&&1!=data.status){
                            ...
                            $('input[type=text]').not("#searchCopyTreeInput").attr("readonly","readonly");
//                            $('input[type=text]').attr("readonly","readonly");
//                            $("#searchCopyTreeInput").removeAttr("readonly");
                        }
                    }
                );
            })
    ...
    window.excelDownload =function(){
        ...
        var uu = apiHost + '/hoss/sys/budget/toExcelDownloadByBudgetId.do?id='+id;
