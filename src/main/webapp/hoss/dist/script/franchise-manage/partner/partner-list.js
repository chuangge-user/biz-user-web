   ...
   //areaPicker.provinceToCityNoMatch($province, $city);
    ...
    function domReady() {
        ...
        var $searchForm = $('#searchForm'),
            ...
            queryListCode = '/hoss/league/apply/getLeaguePartnerPages.do',
            $tabType = $('#tabType')
        ...
        $searchForm.on('submit', function (event) {
            var $context = $(this),
                ...
                tabType = $tabType.val(),
                tabTypeId = ['meetingResultList', 'giveupResultList', 'complatedResultList'][tabType]
                $searchResultList = $('#' + tabTypeId)
