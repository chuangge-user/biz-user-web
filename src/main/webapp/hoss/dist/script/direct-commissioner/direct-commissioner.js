...
define(function (require) {
    ...
    function domReady() {
        ...
        var tobasicinfomation=$('.to-basic-infomation'),//查看基本信息
            tosubordinate=$('.to-subordinate'),//转移下线
            tocustomer=$('.to-customer');//转移客户

        tobasicinfomation.each(function(){
            $(this).click(function(){
                window.location.href='basic-information.html';
            }) ;
        });

        tosubordinate.each(function(){
           $(this).click(function(){
               window.location.href='transfer-subordinate.html';
           }) ;
        });

        tocustomer.each(function(){
            $(this).click(function(){
                window.location.href='../direct-broker/transfer-customer.html';
            }) ;
        });
